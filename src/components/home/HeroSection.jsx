...
export default function HeroSection({ onOpenApplication }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-24 pb-16 sm:pt-28 sm:pb-20 lg:pt-32 lg:pb-28 w-full">
        <div className="max-w-4xl">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black text-gray-900 leading-[0.95] tracking-tight mb-6"
          >
            Stop Letting Your
            <br />
            Potential Go{" "}
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-gray-500 max-w-2xl leading-relaxed mb-8 sm:mb-10"
          >
          ...
          >
            <Link
              ...
              className="group inline-flex items-center gap-2.5 px-5 py-3.5 sm:px-7 sm:py-4 bg-black text-white font-semibold rounded-full hover:bg-gray-800 transition-all duration-300 shadow-2xl shadow-black/20 hover:shadow-black/30 hover:scale-[1.02]"
            >
              Apply Now
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-3.5 sm:px-7 sm:py-4 border border-gray-200 text-gray-700 font-semibold rounded-full hover:bg-gray-50 hover:border-gray-300 transition-all duration-300"
            >
              Learn More
            </button>
          </motion.div>
          ...
          >
            {pillars.map((p, i) => (
              <div
                key={i}
                className="group relative bg-white/60 backdrop-blur-sm border border-gray-200/80 rounded-2xl p-4 sm:p-5 hover:border-gray-300 hover:shadow-lg transition-all duration-300"
              >
